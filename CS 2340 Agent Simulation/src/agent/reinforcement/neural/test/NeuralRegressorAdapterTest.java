...
import agent.reinforcement.neural.NeuralRegressorAdapter;

public class NeuralRegressorAdapterTest {
	
	private NeuralRegressorAdapter nr;
	private Random r;

	public NeuralRegressorAdapterTest() {
	}
